...
# code is written to be able to jointly infer speaker's rationality and
# neural model, but for simplicity, let's assume these are fixed
...
# generate a sentence by unfolding stepwise, from the speaker: greedy unrolling
# used here, not beam search: much better to use beam search generally
